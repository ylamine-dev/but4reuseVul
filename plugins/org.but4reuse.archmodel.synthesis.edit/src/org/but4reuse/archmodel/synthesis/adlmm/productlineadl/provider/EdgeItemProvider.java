...
/**
 * This is the item provider adapter for a {@link org.but4reuse.archmodel.synthesis.adlmm.productlineadl.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_child_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_child_feature", "_UI_Edge_type"),
				 ProductlineadlPackage.Literals.EDGE__CHILD,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProductlineadlPackage.Literals.EDGE__VALUE,
				 true,
				 false,
				 false,

...
/**
 * This is the item provider adapter for a {@link org.but4reuse.archmodel.synthesis.adlmm.productlineadl.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProductlineadlPackage.Literals.CONNECTOR__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Connector)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Connector.class)) {
			case ProductlineadlPackage.CONNECTOR__VALUE:

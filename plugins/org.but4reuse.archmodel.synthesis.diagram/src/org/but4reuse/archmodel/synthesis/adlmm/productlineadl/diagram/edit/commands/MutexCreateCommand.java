...
public class MutexCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MutexCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMutex_4015(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Mutex newElement = ProductlineadlFactory.eINSTANCE.createMutex();

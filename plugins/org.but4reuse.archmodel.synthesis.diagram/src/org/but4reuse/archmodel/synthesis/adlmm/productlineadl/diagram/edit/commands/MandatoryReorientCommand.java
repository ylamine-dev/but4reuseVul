 ...
 * @generated
 */
public class MandatoryReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MandatoryReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Mandatory) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMandatory_4011(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Feature container = (Feature) getLink().eContainer();
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMandatory_4011(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Mandatory getLink() {
		return (Mandatory) getElementToEdit();
	}

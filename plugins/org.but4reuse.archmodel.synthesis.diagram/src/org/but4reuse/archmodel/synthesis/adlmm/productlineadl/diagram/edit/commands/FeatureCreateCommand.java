...
public class FeatureCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Feature newElement = ProductlineadlFactory.eINSTANCE.createFeature();

		SoftwareProductLineArchitecture owner = (SoftwareProductLineArchitecture) getElementToEdit();

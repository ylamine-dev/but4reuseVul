 ...
 * @generated
 */
public class ProductlineadlDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page.openEditor(new URIEditorInput(diagram.getURI()),
				ProductlineadlDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.ProductlineadlDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.ProductlineadlDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = ProductlineadlDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						Messages.ProductlineadlDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.ProductlineadlDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				SoftwareProductLineArchitecture model = createInitialModel();
				...
				try {
					modelResource
							.save(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.part.ProductlineadlDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.part.ProductlineadlDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static SoftwareProductLineArchitecture createInitialModel() {
		return ProductlineadlFactory.eINSTANCE
				.createSoftwareProductLineArchitecture();
	}
	...
	private static void attachModelToResource(
			SoftwareProductLineArchitecture model, Resource resource) {

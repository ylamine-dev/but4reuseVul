...
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.edit.policies.ProductlineadlTextSelectionEditPolicy;
...
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.providers.ProductlineadlParserProvider;
 ...
 * @generated
 */
public class FeatureIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FeatureIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ProductlineadlParserProvider
					.getParser(
							ProductlineadlElementTypes.Feature_2003,
							getParserElement(),
							ProductlineadlVisualIDRegistry
									.getType(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.edit.parts.FeatureIdEditPart.VISUAL_ID));
		}
		return parser;
	}

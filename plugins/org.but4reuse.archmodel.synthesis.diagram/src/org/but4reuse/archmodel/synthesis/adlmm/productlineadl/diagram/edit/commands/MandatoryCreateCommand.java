 ...
 * @generated
 */
public class MandatoryCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MandatoryCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMandatory_4011(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Mandatory newElement = ProductlineadlFactory.eINSTANCE
				.createMandatory();
	 ...
	 * @generated
	 */
	protected void doConfigure(Mandatory newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {

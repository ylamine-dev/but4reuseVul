 ...
 * @generated
 */
public class RequireCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final SoftwareProductLineArchitecture container;

	/**
	 * @generated
	 */
	public RequireCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateRequire_4014(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Require newElement = ProductlineadlFactory.eINSTANCE.createRequire();
	 ...
	 * @generated
	 */
	protected void doConfigure(Require newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
	 ...
	 * @generated
	 */
	public SoftwareProductLineArchitecture getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static SoftwareProductLineArchitecture deduceContainer(
			EObject source, EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof SoftwareProductLineArchitecture) {
				return (SoftwareProductLineArchitecture) element;
			}
		}
		return null;
	}

package org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.application;

import java.io.File;
import java.util.Iterator;

import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.part.Messages;
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.diagram.part.ProductlineadlCreationWizard;
...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ProductlineadlCreationWizard wizard = new ProductlineadlCreationWizard();

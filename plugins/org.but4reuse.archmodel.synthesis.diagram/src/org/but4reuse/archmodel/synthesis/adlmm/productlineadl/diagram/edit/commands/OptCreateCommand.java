 ...
 * @generated
 */
public class OptCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public OptCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Opt newElement = ProductlineadlFactory.eINSTANCE.createOpt();

		Feature owner = (Feature) getElementToEdit();
		owner.setOperator(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Opt newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {

 ...
 * @generated
 */
public class OptionalCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OptionalCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateOptional_4012(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Optional newElement = ProductlineadlFactory.eINSTANCE.createOptional();
		getContainer().getOutgoingEdge().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Optional newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {

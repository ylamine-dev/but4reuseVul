 ...
 * @generated
 */
public class RequireReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequireReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Require) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequire_4014(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		SoftwareProductLineArchitecture container = (SoftwareProductLineArchitecture) getLink()
				.eContainer();
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequire_4014(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Require getLink() {
		return (Require) getElementToEdit();
	}

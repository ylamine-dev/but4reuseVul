...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>productlineadl</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductlineadlExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.productlineadl"));
				SoftwareProductLineArchitecture root = ProductlineadlFactory.eINSTANCE.createSoftwareProductLineArchitecture();

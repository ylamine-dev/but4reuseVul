...
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.edit.policies.ProductlineadlTextSelectionEditPolicy;
...
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.providers.ProductlineadlParserProvider;
 ...
 * @generated
 */
public class CompositeElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeElementNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ProductlineadlTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return ProductlineadlElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ProductlineadlParserProvider
					.getParser(
							ProductlineadlElementTypes.CompositeElement_2001,
							getParserElement(),
							ProductlineadlVisualIDRegistry
									.getType(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.edit.parts.CompositeElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class InterfaceConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InterfaceConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null
				&& false == source instanceof RequiredInterfaceElement) {
			return false;
		}
		if (target != null
				&& false == target instanceof ProvidedInterfaceElement) {
			return false;
		}
		if (getSource() == null) {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInterfaceConnector_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		InterfaceConnector newElement = ProductlineadlFactory.eINSTANCE
				.createInterfaceConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(InterfaceConnector newElement,
	 ...
	 * @generated
	 */
	protected RequiredInterfaceElement getSource() {
		return (RequiredInterfaceElement) source;
	}

	/**
	 * @generated
	 */
	protected ProvidedInterfaceElement getTarget() {
		return (ProvidedInterfaceElement) target;
	}

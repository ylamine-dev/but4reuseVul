 ...
 * @generated
 */
public class CompositeElementCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public CompositeElementCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		CompositeElement newElement = ProductlineadlFactory.eINSTANCE
				.createCompositeElement();

		Feature owner = (Feature) getElementToEdit();
		owner.getModel().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(CompositeElement newElement,

 ...
 * @generated
 */
public class ImportedPackageElementItemSemanticEditPolicy extends
		ProductlineadlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ImportedPackageElementItemSemanticEditPolicy() {
		super(ProductlineadlElementTypes.ImportedPackageElement_3009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ProductlineadlVisualIDRegistry.getVisualID(outgoingLink) == PackageConnectorEditPart.VISUAL_ID) {

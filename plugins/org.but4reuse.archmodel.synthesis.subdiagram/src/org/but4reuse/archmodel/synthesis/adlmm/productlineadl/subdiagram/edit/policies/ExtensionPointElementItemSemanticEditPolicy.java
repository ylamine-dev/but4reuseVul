 ...
 * @generated
 */
public class ExtensionPointElementItemSemanticEditPolicy extends
		ProductlineadlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ExtensionPointElementItemSemanticEditPolicy() {
		super(ProductlineadlElementTypes.ExtensionPointElement_3006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ProductlineadlVisualIDRegistry.getVisualID(incomingLink) == ExtensionConnectorEditPart.VISUAL_ID) {

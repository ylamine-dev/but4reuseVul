 ...
 * @generated
 */
public class ConsumedServiceElementItemSemanticEditPolicy extends
		ProductlineadlBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ConsumedServiceElementItemSemanticEditPolicy() {
		super(ProductlineadlElementTypes.ConsumedServiceElement_3005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ProductlineadlVisualIDRegistry.getVisualID(outgoingLink) == ServiceConnectorEditPart.VISUAL_ID) {

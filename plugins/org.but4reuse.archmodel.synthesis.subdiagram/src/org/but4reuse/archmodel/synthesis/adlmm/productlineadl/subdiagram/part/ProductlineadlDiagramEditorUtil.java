...
public class ProductlineadlDiagramEditorUtil {
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				Feature model = createInitialModel();
				...
				try {
					modelResource
							.save(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.part.ProductlineadlDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.part.ProductlineadlDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static Feature createInitialModel() {
		return ProductlineadlFactory.eINSTANCE.createFeature();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(Feature model, Resource resource) {

...
import org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.part.ProductlineadlLinkDescriptor;
...
public class FeatureCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProductlineadlPackage.eINSTANCE.getFeature_Model();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ProductlineadlNodeDescriptor> childDescriptors = ProductlineadlDiagramUpdater
				.getFeature_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return CompositeElementEditPart.VISUAL_ID == ProductlineadlVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ProductlineadlNodeDescriptor> childDescriptors = ProductlineadlDiagramUpdater
				.getFeature_1000SemanticChildren((View) getHost().getModel());
	...
	private Collection<ProductlineadlLinkDescriptor> collectAllLinks(View view,
		...
		if (!FeatureEditPart.MODEL_ID.equals(ProductlineadlVisualIDRegistry
				.getModelID(view))) {
		...
		case FeatureEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getFeature_1000ContainedLinks(view));
			}
		...
		case CompositeElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getCompositeElement_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PluginElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getPluginElement_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RequiredInterfaceElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getRequiredInterfaceElement_3003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExportedPackageElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getExportedPackageElement_3008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ImportedPackageElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getImportedPackageElement_3009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ProvidedInterfaceElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getProvidedInterfaceElement_3002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExtensionPointElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getExtensionPointElement_3006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RegisteredServiceElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getRegisteredServiceElement_3004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExtensionElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getExtensionElement_3007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ConsumedServiceElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getConsumedServiceElement_3005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case InterfaceConnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getInterfaceConnector_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ServiceConnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getServiceConnector_4004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case PackageConnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getPackageConnector_4003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ExtensionConnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ProductlineadlDiagramUpdater
						.getExtensionConnector_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}

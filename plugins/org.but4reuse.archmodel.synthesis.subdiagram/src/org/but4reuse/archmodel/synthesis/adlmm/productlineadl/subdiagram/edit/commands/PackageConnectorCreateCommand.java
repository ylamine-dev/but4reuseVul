 ...
 * @generated
 */
public class PackageConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PackageConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ImportedPackageElement) {
			return false;
		}
		if (target != null && false == target instanceof ExportedPackageElement) {
			return false;
		}
		if (getSource() == null) {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreatePackageConnector_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		PackageConnector newElement = ProductlineadlFactory.eINSTANCE
				.createPackageConnector();
	 ...
	 * @generated
	 */
	protected void doConfigure(PackageConnector newElement,
	 ...
	 * @generated
	 */
	protected ImportedPackageElement getSource() {
		return (ImportedPackageElement) source;
	}

	/**
	 * @generated
	 */
	protected ExportedPackageElement getTarget() {
		return (ExportedPackageElement) target;
	}

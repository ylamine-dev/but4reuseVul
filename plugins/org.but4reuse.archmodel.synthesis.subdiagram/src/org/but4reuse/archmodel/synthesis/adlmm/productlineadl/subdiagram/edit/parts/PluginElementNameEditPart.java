 ...
 * @generated
 */
public class PluginElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PluginElementNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ProductlineadlParserProvider
					.getParser(
							ProductlineadlElementTypes.PluginElement_3001,
							getParserElement(),
							ProductlineadlVisualIDRegistry
									.getType(org.but4reuse.archmodel.synthesis.adlmm.productlineadl.subdiagram.edit.parts.PluginElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class ServiceConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof ConsumedServiceElement) {
			return false;
		}
		if (target != null
				&& false == target instanceof RegisteredServiceElement) {
			return false;
		}
		if (getSource() == null) {
		...
		return ProductlineadlBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateServiceConnector_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ServiceConnector newElement = ProductlineadlFactory.eINSTANCE
	 ...
	 * @generated
	 */
	protected void doConfigure(ServiceConnector newElement,
	 ...
	 * @generated
	 */
	protected ConsumedServiceElement getSource() {
		return (ConsumedServiceElement) source;
	}

	/**
	 * @generated
	 */
	protected RegisteredServiceElement getTarget() {
		return (RegisteredServiceElement) target;
	}

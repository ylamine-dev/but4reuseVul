...
public class ProductlineadlNewDiagramFileWizard extends Wizard {
	...
	public ProductlineadlNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage.setFileName(ProductlineadlDiagramEditorUtil
				.getUniqueFileName(filePath, fileName, "feature_diagram")); //$NON-NLS-1$
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = ProductlineadlVisualIDRegistry
						.getDiagramVisualID(diagramRootElementSelectionPage
								.getModelElement());
				if (diagramVID != FeatureEditPart.VISUAL_ID) {

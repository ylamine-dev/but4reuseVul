...
public class CompositeElementCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ProductlineadlPackage.eINSTANCE.getCompositeElement_Components();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ProductlineadlNodeDescriptor> childDescriptors = ProductlineadlDiagramUpdater
				.getCompositeElement_2001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PluginElementEditPart.VISUAL_ID == ProductlineadlVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ProductlineadlNodeDescriptor> childDescriptors = ProductlineadlDiagramUpdater
				.getCompositeElement_2001SemanticChildren((View) getHost()
						.getModel());
